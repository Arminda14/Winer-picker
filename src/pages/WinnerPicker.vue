...
<div 
  ...
  v-if="currentName"
   ...
   <q-card-section>
     <div class="text-h2">{{ currentName }} </div>
   </q-card-section>
  ...
  <q-btn
   ...
   @click="startAgain"
   color="primary"
   class="start-again absolute bg-red"
   label="Start again"
  />
...
.stage{
      background-image: url(/icons/stage.jpg);
...
.curtain{
      background-image: url(/icons/curtain.png);
      background-size: cover;
      background-position: center;
      z-index: 2;
